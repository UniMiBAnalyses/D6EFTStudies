{
  ...
  h_cW_0p1->Draw ("same") ;
  legend->Draw () ;
  c_0p1->Print (variable + "_0p1.gif", "gif") ;
...
//  TFile * inputf_0p3 = new TFile ("histograms_RcW_0p3_GP_10K.root", "read") ;
//  TFile * inputf_0p3 = new TFile ("histograms_RcW_0p3_GP_100K.root", "read") ;
  TFile * inputf_0p3 = new TFile ("histograms_RcW_0p3_GP_50K.root", "read") ;
//  TFile * inputf_0p3 = new TFile ("pesi_new.root", "read") ;
  inputf_0p3->ls () ;
  ...
  h_cW_0p3->Draw ("same") ;
  legend->Draw () ;
  c_0p3->Print (variable + "_0p3.gif", "gif") ;
...
// ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- 
  ...
  h_cW_0p05->Draw ("same") ;
  legend->Draw () ;
  c_0p05->Print (variable + "_0p05.gif", "gif") ;
...
//  c_int->DrawFrame (200, 0.0000001, 1800, 0.003) ;
  ...
  c_int->Print (variable + "_shapes_int.gif", "gif") ;
...
//  c_bsm->DrawFrame (200, 0.0000001, 1800, 0.003) ;
  ...
  c_bsm->Print (variable + "_shapes_bsm.gif", "gif") ;
...
// ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- 
  ...
  c_compare->Print (variable + "_shapes.gif", "gif") ;  
