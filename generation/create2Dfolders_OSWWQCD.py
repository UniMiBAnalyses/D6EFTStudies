...
if __name__ == "__main__":
  ...
  #switchOn = ['21', '32', '46', '48', '49', '54', '55', '56', '57', '58']
  switchOn = ['21', '25', '28', '32', '45', '46', '48', '49']
  proc_ID = 'OSWWQCD'
...
# sort the list alphabetically according to the parameter name
  ...
  for i in range (len (sortedsel)):
    for j in range (i+1, len (sortedsel)):
      ...
      f_launchfile = open ('launch_' + proc_ID + '_' + tag + '_IN.txt', 'w')
      f_launchfile.write ('import model SMEFTsim_U35_MwScheme_UFO-' + tag + '_massless\n')
      f_launchfile.write ('generate p p > e+ ve mu- vm~ j j QCD==2  SMHLOOP=0 NP==1  NP' + sortedsel[i][1] + '^2==1   NP' + sortedsel[j][1] + '^2==1\n')
      f_launchfile.write ('add process p p > e- ve~ mu+ vm j j QCD==2  SMHLOOP=0 NP==1  NP' + sortedsel[i][1] + '^2==1   NP' + sortedsel[j][1] + '^2==1\n')
      f_launchfile.write ('output ' + proc_ID + '_' + tag + '_IN')
      f_launchfile.close ()
