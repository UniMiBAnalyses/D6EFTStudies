...
#  switchOn = ['21']
  ...
  f_launchfile = open ('launch_SSWW_cHq3_LinearProp.txt', 'w')
  f_launchfile.write ('import model SMEFTsim_A_U35_MwScheme_UFO-cHq3_massless\n')
  f_launchfile.write ('generate p p > e+ ve mu+ vm j j QCD=0 SMHLOOP=0 NP=0\n')
  f_launchfile.write ('add process p p > e- ve~ mu- vm~ j j QCD=0 SMHLOOP=0 NP=0\n')
  f_launchfile.write ('output SSWW_SM')
  f_launchfile.close ()
