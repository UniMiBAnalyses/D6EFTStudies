...
C     
C     Process: u c > e+ ve mu+ vm d s NP<=1 QCD=0 NP^2==2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,2),W(1,11),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV1_4_0(W(1,6),W(1,8),W(1,17),-GC_234,GC_248,AMP(13))
      CALL FFV1_1(W(1,8),W(1,11),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV1_7_0(W(1,2),W(1,6),W(1,17),GC_234,GC_248,AMP(14))
      CALL FFV1_2(W(1,2),W(1,4),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV1_4_0(W(1,6),W(1,8),W(1,14),-GC_234,GC_248,AMP(15))
      CALL FFV1_1(W(1,8),W(1,4),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 16
      CALL FFV1_7_0(W(1,2),W(1,6),W(1,14),GC_234,GC_248,AMP(16))
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV1_7_3(W(1,1),W(1,14),GC_234,GC_248,MDL_MZ, FK_MDL_WZ,W(1
     $ ,11))
C     Amplitude(s) for diagram number 18
      CALL FFV3_0(W(1,5),W(1,12),W(1,11),GC_336,AMP(18))
      CALL FFV1_2(W(1,1),W(1,4),GC_233,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 19
      ...
      CALL FFV1_7_3(W(1,1),W(1,12),GC_234,GC_248,MDL_MZ, FK_MDL_WZ,W(1
     $ ,4))
