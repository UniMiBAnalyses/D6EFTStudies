...
C     
C     Process: d~ d~ > e+ ve mu+ vm u~ u~ NP<=1 QCD=0 NP^2==2 @1
C     Process: s~ s~ > e+ ve mu+ vm c~ c~ NP<=1 QCD=0 NP^2==2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1_3(W(1,7),W(1,1),GC_233,MDL_MW, FK_MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_4_0(W(1,16),W(1,2),W(1,17),-GC_234,GC_248,AMP(13))
      CALL FFV1_1(W(1,2),W(1,11),GC_233,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 14
      CALL FFV1_7_0(W(1,8),W(1,9),W(1,17),GC_234,GC_248,AMP(14))
      CALL FFV1_2(W(1,8),W(1,18),GC_233,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 15
      CALL FFV1_4_0(W(1,17),W(1,2),W(1,14),-GC_234,GC_248,AMP(15))
      CALL FFV1_1(W(1,2),W(1,18),GC_233,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 16
      CALL FFV1_7_0(W(1,8),W(1,13),W(1,14),GC_234,GC_248,AMP(16))
      CALL FFV1_3(W(1,7),W(1,2),GC_233,MDL_MW, FK_MDL_WW,W(1,14))
      CALL FFV1_3(W(1,8),W(1,1),GC_233,MDL_MW, FK_MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_4_0(W(1,16),W(1,1),W(1,19),-GC_234,GC_248,AMP(29))
      CALL FFV1_1(W(1,1),W(1,11),GC_233,ZERO, FK_ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_4_0(W(1,17),W(1,1),W(1,22),-GC_234,GC_248,AMP(31))
      CALL FFV1_1(W(1,1),W(1,18),GC_233,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 32
      CALL FFV1_7_0(W(1,8),W(1,17),W(1,22),GC_234,GC_248,AMP(32))
      CALL FFV1_2(W(1,7),W(1,11),GC_233,ZERO, FK_ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 33
      ...
      CALL FFV1_7_3(W(1,7),W(1,9),GC_234,GC_248,MDL_MZ, FK_MDL_WZ,W(1
     $ ,11))
C     Amplitude(s) for diagram number 34
      CALL FFV3_0(W(1,5),W(1,20),W(1,11),GC_336,AMP(34))
      CALL FFV1_2(W(1,7),W(1,18),GC_233,ZERO, FK_ZERO,W(1,11))
