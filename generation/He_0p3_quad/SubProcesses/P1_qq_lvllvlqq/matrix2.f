...
C     
C     Process: u d~ > e+ ve mu+ vm d u~ NP<=1 QCD=0 NP^2==2 @1
C     Process: c s~ > e+ ve mu+ vm s c~ NP<=1 QCD=0 NP^2==2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1_3(W(1,1),W(1,2),GC_233,MDL_MW, FK_MDL_WW,W(1,9))
      CALL FFV1_3(W(1,8),W(1,7),GC_233,MDL_MW, FK_MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,8),W(1,11),GC_233,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 13
      CALL FFV1_4_0(W(1,16),W(1,7),W(1,17),-GC_234,GC_248,AMP(13))
      CALL FFV1_1(W(1,7),W(1,11),GC_233,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 14
      CALL FFV1_7_0(W(1,8),W(1,9),W(1,17),GC_234,GC_248,AMP(14))
      CALL FFV1_2(W(1,8),W(1,18),GC_233,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 15
      CALL FFV1_4_0(W(1,17),W(1,7),W(1,14),-GC_234,GC_248,AMP(15))
      CALL FFV1_1(W(1,7),W(1,18),GC_233,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 16
      CALL FFV1_7_0(W(1,8),W(1,13),W(1,14),GC_234,GC_248,AMP(16))
      CALL FFV1_3(W(1,1),W(1,7),GC_233,MDL_MW, FK_MDL_WW,W(1,14))
      CALL FFV1_3(W(1,8),W(1,2),GC_233,MDL_MW, FK_MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_4_0(W(1,16),W(1,2),W(1,19),-GC_234,GC_248,AMP(29))
      CALL FFV1_1(W(1,2),W(1,11),GC_233,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 30
      CALL FFV1_7_0(W(1,8),W(1,16),W(1,19),GC_234,GC_248,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_4_0(W(1,17),W(1,2),W(1,22),-GC_234,GC_248,AMP(31))
      CALL FFV1_1(W(1,2),W(1,18),GC_233,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 32
      CALL FFV1_7_0(W(1,8),W(1,17),W(1,22),GC_234,GC_248,AMP(32))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_4_3(W(1,22),W(1,2),-GC_234,GC_248,MDL_MZ, FK_MDL_WZ
     $ ,W(1,18))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1_4_3(W(1,11),W(1,2),-GC_234,GC_248,MDL_MZ, FK_MDL_WZ
     $ ,W(1,18))
