...
C     
C     Process: c s~ > e+ ve mu+ vm d u~ NP<=1 QCD=0 NP^2==2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1_3(W(1,8),W(1,7),GC_233,MDL_MW, FK_MDL_WW,W(1,9))
      CALL FFV1_3(W(1,1),W(1,2),GC_233,MDL_MW, FK_MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL VVV5_3(W(1,9),W(1,11),GC_236,MDL_MZ, FK_MDL_WZ,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV3_0(W(1,5),W(1,12),W(1,4),GC_336,AMP(9))
      CALL VVV5_3(W(1,10),W(1,11),GC_236,MDL_MZ, FK_MDL_WZ,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL FFV3_0(W(1,5),W(1,16),W(1,4),GC_336,AMP(10))
      CALL FFV1_3(W(1,5),W(1,6),GC_233,MDL_MW, FK_MDL_WW,W(1,4))
      CALL VVV5_3(W(1,10),W(1,4),GC_236,MDL_MZ, FK_MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 11
      CALL FFV3_0(W(1,3),W(1,13),W(1,6),GC_336,AMP(11))
      CALL VVV5_3(W(1,9),W(1,4),GC_236,MDL_MZ, FK_MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 12
      CALL FFV3_0(W(1,3),W(1,15),W(1,6),GC_336,AMP(12))
      CALL FFV1_2(W(1,1),W(1,11),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV1_4_0(W(1,6),W(1,2),W(1,17),-GC_234,GC_248,AMP(13))
      CALL FFV1_1(W(1,2),W(1,11),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV1_7_0(W(1,1),W(1,6),W(1,17),GC_234,GC_248,AMP(14))
      CALL FFV1_2(W(1,1),W(1,4),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV1_4_0(W(1,6),W(1,2),W(1,14),-GC_234,GC_248,AMP(15))
      CALL FFV1_1(W(1,2),W(1,4),GC_233,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 16
      CALL FFV1_7_0(W(1,1),W(1,6),W(1,14),GC_234,GC_248,AMP(16))
      CALL FFV1_2(W(1,8),W(1,11),GC_233,ZERO, FK_ZERO,W(1,6))
      CALL FFV1_4_3(W(1,6),W(1,7),-GC_234,GC_248,MDL_MZ, FK_MDL_WZ,W(1
     $ ,14))
C     Amplitude(s) for diagram number 17
      CALL FFV3_0(W(1,5),W(1,12),W(1,14),GC_336,AMP(17))
      CALL FFV1_1(W(1,7),W(1,11),GC_233,ZERO, FK_ZERO,W(1,14))
      CALL FFV1_7_3(W(1,8),W(1,14),GC_234,GC_248,MDL_MZ, FK_MDL_WZ,W(1
     $ ,11))
C     Amplitude(s) for diagram number 18
      CALL FFV3_0(W(1,5),W(1,12),W(1,11),GC_336,AMP(18))
      CALL FFV1_2(W(1,8),W(1,4),GC_233,ZERO, FK_ZERO,W(1,11))
      CALL FFV1_4_3(W(1,11),W(1,7),-GC_234,GC_248,MDL_MZ, FK_MDL_WZ
     $ ,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV3_0(W(1,3),W(1,15),W(1,12),GC_336,AMP(19))
      CALL FFV1_1(W(1,7),W(1,4),GC_233,ZERO, FK_ZERO,W(1,12))
      CALL FFV1_7_3(W(1,8),W(1,12),GC_234,GC_248,MDL_MZ, FK_MDL_WZ,W(1
     $ ,4))
C     Amplitude(s) for diagram number 20
      CALL FFV3_0(W(1,3),W(1,15),W(1,4),GC_336,AMP(20))
