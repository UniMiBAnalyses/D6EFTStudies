...
# to submit the folder generation:  for fil in `ls | grep launch_ZV` ; do ./bin/mg5_aMC $fil ;done
...
#  switchOn = ['21']
  ...
  for param in params:
    ...
    f_launchfile.write ('generate    p p > e+ e- j j j j QCD=0 NP=1 NP^2==1 SMHLOOP=0\n')
    f_launchfile.write ('add process p p > mu+ mu- j j j j QCD=0 NP=1 NP^2==1 SMHLOOP=0\n')
    # f_launchfile.write ('add process p p > tau+ tau- j j j j QCD=0 NP=1 NP^2==1 SMHLOOP=0\n')
  ...
  for param in params:
    ...
    f_launchfile.write ('add process p p > mu+ mu- j j j j QCD=0 NP=1 NP^2==2 SMHLOOP=0\n')
    # f_launchfile.write ('add process p p > tau+ tau- j j j j QCD=0 NP=1 NP^2==2 SMHLOOP=0\n')
  ...
  if (len (sys.argv) > 1):
    ...
    f_launchfile.write ('generate    p p > e+ e- j j j j QCD=0 SMHLOOP=0\n')
    f_launchfile.write ('add process p p > mu+ mu- j j j j QCD=0 SMHLOOP=0\n')
    # f_launchfile.write ('add process p p > tau+ tau- j j j j QCD=0 SMHLOOP=0\n')
