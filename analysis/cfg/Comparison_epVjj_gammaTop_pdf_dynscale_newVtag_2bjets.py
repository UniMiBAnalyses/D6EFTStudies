...
cut = "nbQuarks==2 && mVBS_new > 300 && ptj1 > 30 && ptj2 > 30 && ptj3 > 50 && ptj4 > 50 && ptl1 > 30 && met > 30 && etal1 < 3.0 && etal1 > -3.0 && minmjj > 40 && mindrjl > 0.4  && mindrjj > 0.4"
...
samples = {
   ...
   "SM": {
            ...
            # Benchmark but without top quarks \ t t~
 
            "epVjj_SM_noTop": {"path": "/afs/cern.ch/work/g/gboldrin/public/public/CMSSW_10_6_4/src/D6EFTStudies/generation/EFT/epVewk_SM_noTop_results/ntuple_epVewk_SM_noTop.root", "nameHR": "epVjj SMEFTsim noTop", "color": ROOT.kGreen, "weight": "({})*".format(cut) + "w"},
...
variables = {
   ...
   'mVBS_new': {'min': 0, 'max': 1500, 'bins': 20},
...
output = "plots_beckmarking_newVtagging_2bjets"
